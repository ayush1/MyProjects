...
public class BluetoothConnetivityActivity extends Activity {

	private static final String TAG="BluetoothConnetivityActivity";
	private static final boolean D=true;
	
	private static final String Name="BluetoothConnetivityActivity";
	...
	Intent i7=this.getIntent();
	long id=i7.getLongExtra("id",1);
	
	public BluetoothConnetivityActivity(Context context,Handler handler) {
		...
		public void run(){
			...
			try{
				...
				try{
					...
					Log.d(TAG,"unable to close()"+mSocketType+"socket during connection failure" ,e2);
				}
